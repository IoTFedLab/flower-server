...
# 클라이언트 IP 주소
CLIENT1_IP="223.194.160.130"  # 시우
CLIENT2_IP="223.194.160.130"  # 민지
CLIENT3_IP="223.194.160.130"  # 소연
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
echo ""
echo "보안 상태:"
echo "   - 9092 포트는 오직 3대 클라이언트만 접근 가능"
echo "   - 다른 모든 IP는 9092 포트 접근 차단"
echo "   - SSH (22) 포트는 모든 IP에서 접근 가능"
echo ""
echo "테스트 방법:"
echo "   클라이언트에서: telnet 203.230.103.35 9092"
echo "   다른 디바이스에서: telnet 203.230.103.35 9092 (차단되어야 함)"
echo ""
echo "주의사항:"
echo "   - 클라이언트 IP가 변경되면 이 스크립트를 다시 실행하세요"
echo "   - 규칙 삭제: sudo ufw delete <규칙번호>"
echo "   - 방화벽 상태 확인: sudo ufw status"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
